...
# MAGIC %md ### Initialize the library
# MAGIC Import statement depending on which framework you're using. 
# MAGIC 
# MAGIC hvd.init() -> sets up communication between workers and "bookkeeping"
